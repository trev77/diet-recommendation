...
# Directories
mkdir -p data/raw data/processed models notebooks src/preprocessing src/training src/evaluation src/utils

# Placeholder Python scripts - They are empty and you should fill them with your code
touch src/preprocessing/data_preprocessing.py
touch src/training/train_model.py
touch src/evaluation/evaluate_model.py
